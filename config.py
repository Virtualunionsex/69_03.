...
# Username CH & Group
CHANNEL = os.environ.get("CHANNEL", "Testivipexo")
GROUP = os.environ.get("GROUP", "Testivipexo")
...
try:
    ADMINS = [int(x) for x in (os.environ.get("ADMINS", "5589797950  2119055068 1245451624 2110216783").split())]
except ValueError:
